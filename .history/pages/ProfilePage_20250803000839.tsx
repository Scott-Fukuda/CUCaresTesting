...
import OrgNameClickable from '../components/OrgNameClickable'; 
            ...
            {userGroups.length > 0 ? (
                <ul className="space-y-3">
                    {userGroups.map(group => (
                        <li key={group.id} className="bg-light-gray p-3 rounded-lg font-medium text-gray-800">
                            <OrgNameClickable org={group} setPageState={setPageState} />
                        </li>
                    ))}
                </ul>
            ) : (
